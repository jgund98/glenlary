...
const frames = [
  ...
  {
    src: "/images/pond-spring.jpg",
    alt: "The turnout pond behind the four-board fence, stables beyond",
    caption: "the turnout pond, stables beyond",
    pos: "center 40%",
    drift: 16,
    lift: "lg:translate-y-6",
  },
  {
    src: "/images/foal-fence.jpg",
    alt: "A foal at the four-board fence in the evening light",
    caption: "the newest resident, saying hello",
    pos: "center 40%",
    drift: -12,
